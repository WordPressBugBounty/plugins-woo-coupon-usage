...
function wcusage_admin_bell_data_ajax() {
    ...
    if ($referral_count > 0) {
        ...
        $referral_message = sprintf(
            esc_html__( 'There have been %1$d new affiliate referrals since %2$s.', 'woo-coupon-usage' ),
            $referral_count,
            date_i18n('F j, Y H:iA', strtotime($date_limit))
        );
    ...
    if (!$notifications_enabled) {
        ...
        <div id="wcusage-admin-bell-dropdown" style="display: none; position: absolute; margin-top: 10px; left: 50%; top: 32px; background: #fff; border: 1px solid #ddd; border-radius: 8px; width: 300px; transform: translateX(-50%); box-shadow: 0 2px 16px rgba(0,0,0,0.12); z-index: 99999;">
            <div style="padding: 12px 16px; border-bottom: 1px solid #eee; font-weight: 600; color: #333; text-align: center;"><?php echo esc_html__( 'Notifications Disabled', 'woo-coupon-usage' ); ?></div>
            <div style="padding: 12px 16px; text-align: center;">
                <a href="#" id="wcusage-toggle-notifications" style="color: #0073aa; text-decoration: underline; font-size: 11px;"><?php echo esc_html__( 'Enable Notifications', 'woo-coupon-usage' ); ?></a>
            </div>
        </div>
        <?php
        ...
        <div id="wcusage-admin-bell-dropdown" style="display: none; position: absolute; margin-top: 10px; left: 50%; top: 32px; background: #fff; border: 1px solid #ddd; border-radius: 8px; width: 300px; transform: translateX(-50%); box-shadow: 0 2px 16px rgba(0,0,0,0.12); z-index: 99999;">
            ...
            <div id="wcusage-admin-bell-referral-section" style="display:block;">
                <div style="padding: 12px 16px; border-bottom: 1px solid #eee; font-weight: 600; color: #333; text-align: center;"><?php echo esc_html__( 'Notifications', 'woo-coupon-usage' ); ?></div>
            ...
            <?php endif; ?>
            <div style="padding: 12px 16px; border-bottom: 1px solid #eee; font-weight: 600; color: #333; text-align: center;"><?php echo esc_html__( 'Pending Admin Tasks', 'woo-coupon-usage' ); ?></div>
            <ul style="list-style: none; margin: 0; padding: 0;" id="wcusage-admin-bell-referral-list">
                ...
                <li style="padding: 10px 16px; border-bottom: 1px solid #f3f3f3; display: flex; align-items: center; gap: 8px; margin-bottom: 0;">
                    ...
                    <span><?php echo esc_html__( 'Pending Registrations:', 'woo-coupon-usage' ); ?></span>
                    <span style="margin-left: auto; font-weight: bold; color: #d9534f;"><?php echo intval($pending_registrations); ?></span>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=wcusage_registrations')); ?>" style="margin-left: 10px; color: #0073aa; text-decoration: underline; font-size: 13px;"><?php echo esc_html__( 'Manage', 'woo-coupon-usage' ); ?></a>
                </li>
                <?php endif; ?>
                ...
                <li style="padding: 10px 16px; border-bottom: 1px solid #f3f3f3; display: flex; align-items: center; gap: 8px; margin-bottom: 0;">
                    ...
                    <a href="<?php echo esc_url(admin_url('admin.php?page=wcusage_domains&status=pending')); ?>" style="margin-left: 10px; color: #6f42c1; text-decoration: underline; font-size: 13px;"><?php echo esc_html__( 'Manage', 'woo-coupon-usage' ); ?></a>
                </li>
                <?php endif; ?>
                <?php if ($pending_payouts > 0): ?>
                <li style="padding: 10px 16px; border-bottom: 1px solid #f3f3f3; display: flex; align-items: center; gap: 8px; margin-bottom: 0;">
                    <span class="fa-solid fa-money-bill" style="color: #28a745;"></span>
                    <span><?php echo esc_html__( 'Pending Payouts:', 'woo-coupon-usage' ); ?></span>
                    <span style="margin-left: auto; font-weight: bold; color: #d9534f;"><?php echo intval($pending_payouts); ?></span>
                    <a href="<?php echo esc_url(admin_url('admin.php?page=wcusage_payouts')); ?>" style="margin-left: 10px; color: #28a745; text-decoration: underline; font-size: 13px;"><?php echo esc_html__( 'Manage', 'woo-coupon-usage' ); ?></a>
                </li>
                <?php endif; ?>
            </ul>
            <?php if ($pending_total == 0 && !$show_affiliate_notification): ?>
            <div style="padding: 12px 16px; color: #888; text-align: center;"><?php echo esc_html__( 'No pending tasks 🎉', 'woo-coupon-usage' ); ?></div>
            <?php endif; ?>
            <div style="padding: 4px 16px 9px 16px; border-top: 1px solid #eee; text-align: center;">
                <a href="#" id="wcusage-toggle-notifications" style="color: #0073aa; text-decoration: underline; font-size: 11px;"><?php echo esc_html__( 'Disable Notifications', 'woo-coupon-usage' ); ?></a>
            </div>
        </div>
        <?php
        $dropdown_html = ob_get_clean();
